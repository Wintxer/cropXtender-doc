<header class="flex justify-between py-6 px-16 max-md:px-10 max-sm:p-4 items-center fixed w-full bg-transparent">
    <div class="flex items-center justify-between w-full self-start z-10">
        ...
        <div class="flex gap-16 max-lg:gap-8 max-md:gap-4 max-sm:hidden">
            <a href="docs.php">Docs</a>
            <a href="editor.php">Éditeur d'image</a>
            <a href="https://github.com/jstm17/cropXtender">Github</a>
            <a href="contact.php">Contact</a>
        </div>
        <button class="burger-menu-icon max-sm:block hidden h-8" data-ic-class="button-trigger">
